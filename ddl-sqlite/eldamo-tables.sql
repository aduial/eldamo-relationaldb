...
CREATE TABLE DOCLINK (
	...
	DOCLINK_TYPE_ID INTEGER NOT NULL,
	CONSTRAINT DOCLINK_PK PRIMARY KEY (PARENT_ID,DOC_ID,DOCLINK_TYPE_ID,"ORDERING"),
	CONSTRAINT FK_DOCLINK_DOC FOREIGN KEY (DOC_ID) REFERENCES DOC(ID),
	CONSTRAINT FK_DOCLINK_TYPE FOREIGN KEY (DOCLINK_TYPE_ID) REFERENCES "TYPE"(ID)
);
CREATE INDEX DOCLINK_PARENT_ID_IDX ON DOCLINK (PARENT_ID,"ORDERING",DOCLINK_TYPE_ID);
...
CREATE INDEX REF_SOURCE_ID_IDX ON "REF" (SOURCE_ID,FORM_ID,REF_TYPE_ID,"ORDERING");
CREATE INDEX REF_ENTRY_ID_IDX ON "REF" (ENTRY_ID,REF_TYPE_ID);
CREATE INDEX REF_REF_ID_IDX ON "REF" (REF_ID,REF_TYPE_ID);
...
CREATE TABLE EIC (
	...
	SOURCE_ID INTEGER,
	FORM_ID INTEGER,
	INFLECT_TYPE_ID INTEGER,
	INFLECT_VAR_TYPE_ID INTEGER,
	MARK VARCHAR(10),
	EIC_TYPE_ID INTEGER,
	...
	CONSTRAINT FK_EIC_INFLECT_TYPE FOREIGN KEY (INFLECT_TYPE_ID) REFERENCES "TYPE"(ID),
	CONSTRAINT FK_EIC_INFLECT_VAR_TYPE FOREIGN KEY (INFLECT_VAR_TYPE_ID) REFERENCES "TYPE"(ID),
...
CREATE INDEX EIC_ENTRY_ID_IDX ON EIC (ENTRY_ID,REF_ID);
